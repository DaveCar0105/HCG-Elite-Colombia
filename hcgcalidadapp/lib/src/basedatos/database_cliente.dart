...
class DatabaseCliente{
  static Future<List<Cliente>> getAllCliente(int valor) async {
    final sql = '''SELECT * FROM ${DatabaseCreator.clienteTable} WHERE ${DatabaseCreator.elite}=$valor''';
  ...
  static Future<int> addCliente(Cliente cliente) async {
    ...
    final sql =
    '''INSERT INTO ${DatabaseCreator.clienteTable}(${DatabaseCreator.clienteId},${DatabaseCreator.clienteNombre},${DatabaseCreator.elite}) 
    VALUES(${cliente.clienteId},'${cliente.clienteNombre}',${cliente.elite})''';
