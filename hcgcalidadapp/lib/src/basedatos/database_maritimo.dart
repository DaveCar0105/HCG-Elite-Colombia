...
class DatabaseProcesoMaritimo {
  static Future<List<ProcesoMaritimo>> getAllProcesoMaritimo() async {
    ...
    for (final node in data) {
      ...
      maritimo.add(new ProcesoMaritimo(
          ...
          procesoMaritimoUsuarioControlId: node[DatabaseCreator.procesoMaritimoUsuarioControlId],
          procesoMaritimoObservaciones: node[DatabaseCreator.procesoMaritimoObservaciones],
          procesoMaritimoNumeroGuia: node[DatabaseCreator.procesoMaritimoNumeroGuia],
          procesoMaritimoDestino: node[DatabaseCreator.procesoMaritimoDestino],
          procesoMaritimoRealizadoPor:node[DatabaseCreator.procesoMaritimoRealizadoPor],
              
          procesoMaritimoAcompanamiento:node[DatabaseCreator.procesomoMaritimoAcompanamiento],
          procesoMaritimoNombreHidratante: node[DatabaseCreator.procesoMaritimoNombreHidratante],
          procesoMaritimoPhSoluciones: node[DatabaseCreator.procesoMaritimoPhSoluciones],

          procesoMaritimoNivelSolucionTinas: node[DatabaseCreator.procesoMaritimoNivelSolucionTinas],
          procesoMaritimoSolucionHidratacionSinVegetal: node[DatabaseCreator.procesoMaritimoSolucionHidratacionSinVegetal],
          procesoMaritimoTemperaturaCuartoFrio: node[DatabaseCreator.procesoMaritimoTemperaturaCuartoFrio],
          procesoMaritimoTemperaturaSolucionesHidratacion: node[DatabaseCreator.procesoMaritimoTemperaturaSolucionesHidratacion],
          procesoMaritimoEmpaqueAmbienteTemperatura: node[DatabaseCreator.procesoMaritimoEmpaqueAmbienteTemperatura],
          procesoMaritimoFlorEmpacada: node[DatabaseCreator.procesoMaritimoFlorEmpacada],
          procesoMaritimoTransportCareEmpaque: node[DatabaseCreator.procesoMaritimoTransportCareEmpaque],
          procesoMaritimoCajasVisualDeformes: node[DatabaseCreator.procesoMaritimoCajasVisualDeformes],
          procesoMaritimoEtiquetasCajasUbicadas: node[DatabaseCreator.procesoMaritimoEtiquetasCajasUbicadas],
          procesoMaritimoTemperaturaCubiculoCamion: node[DatabaseCreator.procesoMaritimoTemperaturaCubiculoCamion],
          procesoMaritimoTemperaturaCajasTransferencia: node[DatabaseCreator.procesoMaritimoTemperaturaCajasTransferencia],
          procesoMaritimoAparenciaCajasTransferencia: node[DatabaseCreator.procesoMaritimoAparenciaCajasTransferencia],
          procesoMaritimoEstibasDebidamenteSelladas: node[DatabaseCreator.procesoMaritimoEstibasDebidamenteSelladas],
          procesoMaritimoPalletsEsquinerosCorrectamenteAjustados: node[DatabaseCreator.procesoMaritimoPalletsEsquinerosCorrectamenteAjustados],
          procesoMaritimoPalletsAlturaContenedor: node[DatabaseCreator.procesoMaritimoPalletsAlturaContenedor],
          procesoMaritimoTemperaturaPalletContenedor: node[DatabaseCreator.procesoMaritimoTemperaturaPalletContenedor],
          procesoMaritimoPalletIdentificadoNumero: node[DatabaseCreator.procesoMaritimoPalletIdentificadoNumero],
          procesoMaritimoTomaRegistroTemperaturas: node[DatabaseCreator.procesoMaritimoTomaRegistroTemperaturas],
          procesoMaritimoGenset: node[DatabaseCreator.procesoMaritimoGenset],
          procesoMaritimoContenedorEdadFabricacion: node[DatabaseCreator.procesoMaritimoContenedorEdadFabricacion],
          procesoMaritimoContenedorCumplimientoSeteo: node[DatabaseCreator.procesoMaritimoContenedorCumplimientoSeteo],
          procesoMaritimoContenedorPreEnfriado: node[DatabaseCreator.procesoMaritimoContenedorPreEnfriado],
          procesoMaritimoContenedorlavadoDesinfectado: node[DatabaseCreator.procesoMaritimoContenedorlavadoDesinfectado],
          procesoMartimoCarguePreviamenteHumedecidos: node[DatabaseCreator.procesoMaritimoCarguePreviamenteHumedecidos],
          procesoMaritimoLlegandoCierreSellado: node[DatabaseCreator.procesoMaritimoLlegandoCierreSellado],
          procesoMaritimoEstibasSelloICA: node[DatabaseCreator.procesoMaritimoEstibasSelloICA],
          procesoMaritimoPalletsTensionZunchos: node[DatabaseCreator.procesoMaritimoPalletsTensionZunchos],
          procesoMaritimoPalletIdentificadoEtiqueta: node[DatabaseCreator.procesoMaritimoPalletIdentificadoEtiqueta],
          procesoMaritimoComponentePalletDestinosEtiquetas: node[DatabaseCreator.procesoMaritimoComponentePalletDestinosEtiquetas],
          procesoMaritimoCamionSelloSeguridadContenedor: node[DatabaseCreator.procesoMaritimoCamionSelloSeguridadContenedor],
          ...
          procesoMaritimoFecha:DateTime.parse(node[DatabaseCreator.procesoMaritimoFecha]),
          ));
    }
    return maritimo;
  }
  ...
  static Future<int> addProcesosHidratacion(
    ...
    ${DatabaseCreator.procesoMaritimoDestino},${DatabaseCreator.procesoMaritimoRealizadoPor},${DatabaseCreator.procesomoMaritimoAcompanamiento},${DatabaseCreator.procesoMaritimoNombreHidratante},${DatabaseCreator.procesoMaritimoPhSoluciones},
     ...
     ${DatabaseCreator.clienteId},${DatabaseCreator.clienteNombre},${DatabaseCreator.postcosechaId},${DatabaseCreator.postcosechaNombre},
     )
    VALUES(${procesoMaritimo.procesoMaritimoUsuarioControlId},${procesoMaritimo.procesoMaritimoObservaciones},${procesoMaritimo.procesoMaritimoNumeroGuia},
    ${procesoMaritimo.procesoMaritimoDestino},${procesoMaritimo.procesoMaritimoRealizadoPor},${procesoMaritimo.procesoMaritimoAcompanamiento},${procesoMaritimo.procesoMaritimoNombreHidratante},${procesoMaritimo.procesoMaritimoPhSoluciones},
     ...
     ${procesoMaritimo.clienteId},${procesoMaritimo.clienteNombre},${procesoMaritimo.postcosechaId},${procesoMaritimo.postcosechaNombre},)''';
