...
class DatabaseFalenciaReporteRamos {
  static Future<List<FalenciaReporteRamos>> getAllFalenciasXRamosId(
      int id) async {
    final sql = '''SELECT 
    ${DatabaseCreator.falenciasReporteRamosTable}.${DatabaseCreator.falenciasReporteRamosId},
    ...
    ${DatabaseCreator.falenciasReporteRamosTable}.${DatabaseCreator.falenciasReporteRamosCantidad}
    FROM
    ...
    for (final node in data) {
      falenciaReporteRamos.add(new FalenciaReporteRamos(
          ...
          falenciasReporteRamosId:
              node[DatabaseCreator.falenciasReporteRamosId],
  ...
  static Future<int> addFalenciaReporteRamos(
    ...
    VALUES(${falenciaReporteRamos.falenciaRamosId},${falenciaReporteRamos.ramosId},
    ${falenciaReporteRamos.falenciasReporteRamosCantidad})''';
    return await db.rawInsert(sql);
  }

  static Future<void> updateCantidadFalenciaReporteRamos(
      FalenciaReporteRamos falenciaReporteRamos) async {
    final sql = '''UPDATE ${DatabaseCreator.falenciasReporteRamosTable}
  ...
  static Future<void> deleteFalenciaReporteRamos(
      int falenciaId, int ramoId) async {
    final sql0 =
