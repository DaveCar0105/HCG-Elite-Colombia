...
class DetalleRegistroProcesoMaritimoAlstroemeriaPage extends StatelessWidget {
  const DetalleRegistroProcesoMaritimoAlstroemeriaPage({Key key})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: FutureBuilder(
        future: DatabaseProcesoMaritimoAlstroemeria
            .getAllProcesoMaritimoAlstromeriaAprobacion(),
        builder: (context,
            AsyncSnapshot<List<ProcesoMaritimoAlstroemeria>> snapshot) {
          if (snapshot.hasData) {
  ...
  String _getValueData(
      ProcesoMaritimoAlstroemeria procesoMaritimoAlstroemeria, String keys) {
