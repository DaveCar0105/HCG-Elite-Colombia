...
class _FalenciasRamosPageState extends State<FalenciasRamosPage> {
        ...
        children: <Widget>[
          ...
          Container(
            ...
            child: RaisedButton(
              ...
              color: Colors.red,
              textColor: Colors.white,
              child: Container(height: 50, width: 50, child: Icon(Icons.add)),
            ),
          )
        ],
      ),
  ...
  agregarFalencia(int ramosId) async {
    ...
    int id = 0;
    try {
      id = listaFalenciasReporte
          .firstWhere((element) =>
              element.falenciaRamosId == falenciaReporteRamos.falenciaRamosId)
  ...
  aumentarFalencia(FalenciaReporteRamos falenciaReporteRamos) async {
    if (falenciaReporteRamos.falenciasReporteRamosCantidad <
        falenciaReporteRamos.total) {
      falenciaReporteRamos.falenciasReporteRamosCantidad++;
      await DatabaseFalenciaReporteRamos.updateCantidadFalenciaReporteRamos(
          falenciaReporteRamos);
    }
