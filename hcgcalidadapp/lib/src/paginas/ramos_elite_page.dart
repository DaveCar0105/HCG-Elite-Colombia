...
class RamosElitePage extends StatefulWidget {
  ...
  @override
  _RamosElitePageState createState() => _RamosElitePageState(this.valor,this.ramosId);
}
        ...
        onPressed: () async{
          ...
          if(_validarRamos() && _validarTallos()){
            ...
            if(numeroOrden != '' &&
              ...
              Navigator.push(context, MaterialPageRoute(builder: (BuildContext context)=>ListaRamosPage(ramos)));
            }else{
              _showSnackBar();
            }
          }
