...
class ProblemasBoncheoPage extends StatefulWidget {
  ControlRamos ramos;
  ProblemasBoncheoPage(this.ramos);
  @override
  _ProblemasBoncheoPageState createState() => _ProblemasBoncheoPageState(this.ramos);
}

class _ProblemasBoncheoPageState extends State<ProblemasBoncheoPage> {
  bool iniciado = false;
  ControlRamos ramos;
  ...
  iniciarCarga(int ramoId) async{
    if(!iniciado){
      ...
      falencias = await DatabaseBoncheo.getAllFalenciasXBandaId(ramoId);
      setState(() {
  ...
  _ProblemasBoncheoPageState(this.ramos);
  @override
        ...
        actions: <Widget>[
          RaisedButton(
            ...
            onPressed: () async{
              ...
              await DatabaseBoncheo.finBandas(ramos1);
  ...
  agregarFalencia(int ramosId) async{
    ...
    await DatabaseBoncheo.addFalenciaReporteBanda(falenciaReporteRamos);
  ...
  aumentarFalencia(FalenciaReporteRamos falenciaReporteRamos)async {
    ...
    await DatabaseBoncheo.updateCantidadFalenciaReporteBanda(falenciaReporteRamos);
  ...
  disminuirFalencia(FalenciaReporteRamos falenciaReporteRamos)async {
    ...
    if(falenciaReporteRamos.falenciasReporteRamosCantidad==0){
      await DatabaseBoncheo.deleteFalenciasBoncheo(falenciaReporteRamos.falenciasReporteRamosId);
    }else{
      await DatabaseBoncheo.updateCantidadFalenciaReporteBanda(falenciaReporteRamos);
    }
