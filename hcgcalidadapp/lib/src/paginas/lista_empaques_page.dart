...
class _ListaEmpaquePageState extends State<ListaEmpaquePage> {
  ...
  _ListaEmpaquePageState(this.empaque){
    print(empaque.controlEmpaqueId);
    cargarEmpaques('');
  }
    ...
    return Scaffold(
      ...
      body: Container(
          child: ListView.builder(
            ...
            itemBuilder: (BuildContext context,int index)=>itemEmpaque(empaques[index],index+1),
          )
      ),
                ...
                children: <Widget>[
                  RaisedButton(
                    ...
                    onPressed: (){
                      ...
                      Navigator.push(context, MaterialPageRoute(builder: (BuildContext context)=>FalenciasPorCaja(0,empaque.controlEmpaqueId,0,cargarEmpaques)));
                    },
                    child: Text('RAMO'),
                  ),
                  RaisedButton(
                    ...
                    onPressed: (){
                      Navigator.pop(context);
                      Navigator.push(context, MaterialPageRoute(builder: (BuildContext context)=>FalenciasPorCaja(0,empaque.controlEmpaqueId,1,cargarEmpaques)));
                    },
                    child: Text('CAJA'),
                  )
                ],
  ...
  itemEmpaque(Empaque empaqueItem,int index){
    ...
    return Container(
      ...
      child: ListTile(
        ...
        subtitle: Text('Falencias: ${empaqueItem.cantidadFalencias} - Tipo:  $tipo'),
        leading: Icon(Icons.local_florist),
        onTap: (){
          Navigator.push(context, MaterialPageRoute(builder: (BuildContext context)=>FalenciasPorCaja(empaqueItem.empaqueId,empaque.controlEmpaqueId,tipoId,cargarEmpaques)));
        },
        trailing: IconButton(
          color: Colors.red,
                      ...
                      Container(
                        child: Row(
                          ...
                          children: <Widget>[
                            ...
                            RaisedButton(
                              onPressed: () async{
                                await DatabaseEmpaque.deleteEmpaque(empaqueItem.empaqueId);
                                Navigator.pop(context);
                                cargarEmpaques('');
                              },
                              color: Colors.red,
