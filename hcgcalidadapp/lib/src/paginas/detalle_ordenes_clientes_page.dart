...
class DetalleOrdenesCliente extends StatefulWidget {
  int clienteId;
  DetalleOrdenesCliente(this.clienteId);
  @override
  _DetalleOrdenesClienteState createState() =>
      _DetalleOrdenesClienteState(this.clienteId);
}

class _DetalleOrdenesClienteState extends State<DetalleOrdenesCliente>
