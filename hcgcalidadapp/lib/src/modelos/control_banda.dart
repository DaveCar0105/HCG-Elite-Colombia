...
ControlBanda ramosFromJson(String str) =>
    ControlBanda.fromJson(json.decode(str));

String ramosToJson(ControlBanda data) => json.encode(data.toJson());
...
class ControlBanda {
  ...
  factory ControlBanda.fromJson(Map<String, dynamic> json) => ControlBanda(
