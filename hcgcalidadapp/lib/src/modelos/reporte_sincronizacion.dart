...
ReporteSincronizacionEmpaque reporteSincronizacionFromJson(String str) => ReporteSincronizacionEmpaque.fromJson(json.decode(str));

String reporteSincronizacionToJson(ReporteSincronizacionEmpaque data) => json.encode(data.toJson());
...
class ReporteSincronizacionEmpaque {
    ...
    factory ReporteSincronizacionEmpaque.fromJson(Map<String, dynamic> json) => ReporteSincronizacionEmpaque(
        firmas: List<Firmas>.from(json["firmas"].map((x) => Firmas.fromJson(x))),
        detallesFirma: List<DetallesFirma>.from(json["detallesFirma"].map((x) => DetallesFirma.fromJson(x))),
       listaEmpaque: List<ListaEmpaque>.from(json["listaEmpaque"].map((x) => ListaEmpaque.fromJson(x))),
    );

    Map<String, dynamic> toJson() => {
        "firmas": List<dynamic>.from(firmas.map((x) => x.toJson())),
        "detallesFirma": List<dynamic>.from(detallesFirma.map((x) => x.toJson())),
        "listaEmpaque": List<dynamic>.from(listaEmpaque.map((x) => x.toJson())),
    };
}
ReporteSincronizacionRamo reporteSincronizacionramoFromJson(String str) => ReporteSincronizacionRamo.fromJson(json.decode(str));

String reporteSincronizacionramoToJson(ReporteSincronizacionEmpaque data) => json.encode(data.toJson());
...
class ReporteSincronizacionRamo {
    ...
    factory ReporteSincronizacionRamo.fromJson(Map<String, dynamic> json) => ReporteSincronizacionRamo(
        firmas: List<Firmas>.from(json["firmas"].map((x) => Firmas.fromJson(x))),
        detallesFirma: List<DetallesFirma>.from(json["detallesFirma"].map((x) => DetallesFirma.fromJson(x))),
        listaRamo: List<ListaRamo>.from(json["listaRamo"].map((x) => ListaRamo.fromJson(x))),
    );
...
class ListaEmpaque {
    ...
    factory ListaEmpaque.fromJson(Map<String, dynamic> json) => ListaEmpaque(
        ...
        elite: json["elite"],
        empaques: List<Empaque>.from(json["empaques"].map((x) => Empaque.fromJson(x))),
    );
...
class Empaque {
    ...
    factory Empaque.fromJson(Map<String, dynamic> json) => Empaque(
        ...
        falencias: List<EmpaqueFalencia>.from(json["falencias"].map((x) => EmpaqueFalencia.fromJson(x))),
    );
...
class EmpaqueFalencia {
    ...
    factory EmpaqueFalencia.fromJson(Map<String, dynamic> json) => EmpaqueFalencia(
...
class Ramo {
    ...
    factory Ramo.fromJson(Map<String, dynamic> json) => Ramo(
        controlRamosId: json["controlRamosId"],
        ramoId: json["ramoId"],
        falencias: List<RamoFalencia>.from(json["falencias"].map((x) => RamoFalencia.fromJson(x))),
    );
...
class RegistroHidratacion {
    ...
    factory RegistroHidratacion.fromJson(Map<String, dynamic> json) => RegistroHidratacion(
...
class RegistroTemperatura {
    ...
    factory RegistroTemperatura.fromJson(Map<String, dynamic> json) => RegistroTemperatura(
