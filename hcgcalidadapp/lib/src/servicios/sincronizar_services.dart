...
class SincServices {
  static Future<List<Control>> postReportesEmpaque(
      ReporteSincronizacionEmpaque reporte) async {
    final co = Constantes();
    List<Control> lista = [];
    ...
    try {
      ...
      var respuesta =
          await http.post(url, body: jsonEncode(reporte), headers: header);
      ...
      if (respuesta.statusCode >= 200 && respuesta.statusCode <= 299) {
        for (int i = 0; i < listaRetorno.length; i++) {
          lista.add(Control.fromJson(listaRetorno[i]));
        }
      } else {
        ErrorT errorT = new ErrorT();
        errorT.errorDetalle = (respuesta.statusCode.toString() +
            ' - ' +
  ...
  static Future<List<Control>> postReportesRamo(
      ReporteSincronizacionRamo reporte) async {
    final co = Constantes();
    List<Control> lista = [];
    Map<String, String> header = {
      'Accept': "application/json",
  ...
  static Future<int> postCirculoCalidad(
      List<CirculoCalidadInformacionGeneral> reporte) async {
    final co = Constantes();
    Map<String, String> header = {
      'Accept': "application/json",
      'content-type': "application/json"
  ...
  static Future<int> postProcesoMaritimo(
      ReporteSincronizacionProcesoMaritimo reporte) async {
    final co = Constantes();
    Map<String, String> header = {
      'Accept': "application/json",
      'content-type': "application/json"
  ...
  static Future<int> postProcesoMaritimoAlstroemeria(
      ReporteSincronizacionProcesoMaritimoAlstroemeria reporte) async {
    final co = Constantes();
    Map<String, String> header = {
      'Accept': "application/json",
      'content-type': "application/json"
  ...
  static Future<int> postAllProcesoMaritimo(
      List<ProcesoMaritimo> reporte) async {
    final co = Constantes();
    Map<String, String> header = {
      'Accept': "application/json",
      'content-type': "application/json"
